 ...
 * 2021-05-05T21:20:33.555+03:00
 * Generated source version: 3.4.3
 *
 */
@WebServiceClient(name = "KPSPublic",
                  wsdlLocation = "file:/C:/java_kamp/GameDemoJava/src/main/resources/Mernis.wsdl",
...
public class KPSPublic extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/java_kamp/GameDemoJava/src/main/resources/Mernis.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(KPSPublic.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/java_kamp/GameDemoJava/src/main/resources/Mernis.wsdl");
        }
        WSDL_LOCATION = url;
    }
